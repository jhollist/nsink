...
- `nsink_plot()` - Plot function to plot removal, transport or delivery static maps.
...
7-zip is needed to extract NHD+ files.  It can been installed in normal ways and if not installed, `nsink` will provide suggestions.  On linux systems without sudo rights you can attempt to build from source and copy the bin folder.
