...
- `nsink_summarize_flowpath()`: Summarizing removal along a flowpath requires relative N removal and a generated flowpath.  This function uses these and returns a  summary of relative N removal along a flowpath for each sink. 
...
- `nsink_plot()`: A function that plots each of raster in the list returned from `nsink_generate_static_maps()`.   
